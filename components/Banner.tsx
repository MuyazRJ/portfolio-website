...
const Banner = () => {
    return ( 
        <div className="md:h-[400px] w-full bg-[#171717] lg:mt-8 flex flex-col items-center justify-center relative z-10 h-[300px]">
            ...
            <div className="flex-1 items-end flex text-center max-w-[70%]">
                <TextReveal>
                    <p className="text-white flex-1 items-end flex text-center [text-shadow:_0_0_10px_rgb(255_255_255_/_54%)] font-bold">Your current website is either outdated, takes too long to load or is not mobile device optmised.</p>
                </TextReveal>
            </div>
