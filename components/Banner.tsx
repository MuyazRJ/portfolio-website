        ...
        <div className="md:h-[400px] w-full bg-[#171717] lg:mt-8 flex flex-col items-center justify-center relative z-10 h-[300px]">
            ...
            <ScrollLink to="form" smooth={true} duration={1200}>
                <CustomButton
                    ...
                    btnType='button'
                    containerStyles='rounded-[8px] bg-main-gold min-w-[130px] max-w-[279px] max-h-[60px] sm:px-5 sm:py-4 px-3 py-4 text-bold hover:bg-white ease-in duration-200 border-transparent mb-10 font-bold'
                />
            </ScrollLink>
            </div>
