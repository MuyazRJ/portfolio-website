    ...
    return (  
        <div className="max-w-[1440px] flex flex-col mx-auto relative">
            ...
            <div className="flex w-full justify-between p-4">
                <Lottie autoPlay={true} loop={true} animationData={revenueData} className="" rendererSettings={{preserveAspectRatio: 'xMidYMid slice'}}/>
            ...
            <div className="flex w-full p-4 gap-40">
                ...
                <div className="w-[450px]"><Lottie autoPlay={true} loop={true} animationData={growData} className="" rendererSettings={{preserveAspectRatio: 'xMidYMid slice'}}/></div>
                
            </div>

            <div className="flex w-full justify-between gap-20">
                <div className="w-[550px]">
                <Lottie autoPlay={true} loop={true} animationData={processData} className="" rendererSettings={{preserveAspectRatio: 'xMidYMid slice'}}/>
                </div>
